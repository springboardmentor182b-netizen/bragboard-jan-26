...
import { Home, User, Trophy, Users, Trophy as TrophyIcon } from 'lucide-react'; // Make sure you have lucide-react installed
    ...
    <div className="w-64 h-screen bg-white border-r border-gray-200 flex flex-col p-6 fixed left-0 top-0 z-10">
      ...
      <div className="mt-auto pt-6 border-t border-gray-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-bold text-gray-700">Sarah Johnson</p>
            <p className="text-xs text-gray-500 cursor-pointer hover:text-red-500">Logout</p>
          </div>
        </div>
      </div>
    </div>
